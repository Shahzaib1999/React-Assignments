...
{
    console.log('props*** from kid component' , props.furtherSteps);
    return {danceSteps : [...state.danceSteps , ...props.furtherSteps],startedPerforming : !!props.furtherSteps.length}
}
